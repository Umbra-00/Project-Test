...
def test_ingest_course_data_batch_existing_course(
    ...
    mock_session.query.return_value.filter_by.return_value.first.return_value = Course(
        id=1, title="Existing Course", url=sample_valid_course_data["url"]
    )
